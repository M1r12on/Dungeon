    ...
    private static List<QuizQuestion> questions = new ArrayList<>() {
        {
            ...
            add(new QuizQuestion(
                new QuizQuestionContent(
                    QuizQuestionContent.QuizQuestionContentType.TEXT,
                    "Mit welchem Befehl kann man sich Dateien in der Workingcopy anzeigen lassen, die unversioniert sind oder in denen es Änderungen seit dem letzten Commit gab?"
                ),
                new QuizQuestionContent[]{ },
            ...
            // Testfrage für sehr lange Antwortmöglichkeiten mit bis zu 77 Buchstaben (optional)
            add(new QuizQuestion(
                new QuizQuestionContent(
                    QuizQuestionContent.QuizQuestionContentType.TEXT,
